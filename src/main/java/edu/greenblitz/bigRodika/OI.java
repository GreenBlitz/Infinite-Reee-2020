...
//        initOfficalButtons();
    ...
    private void initTestButtons() {
        double maxPower = 0.5;
        ProfilingConfiguration config = new ProfilingConfiguration(1, 1, 0.001,0,
                0, 0, 0, 0, 0, 0, 0,
                50);
        ...
        l5.add(new State(1, 0, -Math.PI, 1, -Math.PI/4));
        l5.add(new State(0, -1, Math.PI/2, 1, -Math.PI/4));
        l5.add(new State(-1, 0, 0, 1, -Math.PI/4));
        l6.add(new State(0, 1, -Math.PI/2, 0, 0));
