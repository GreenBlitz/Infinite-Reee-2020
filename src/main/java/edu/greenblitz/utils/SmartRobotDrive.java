...
public class SmartRobotDrive {
    ...
    private BaseMotorController m_frontLeft, m_rearLeft, m_frontRight, m_rearRight;
    ...
    public SmartRobotDrive(BaseMotorController frontLeft, BaseMotorController rearLeft, BaseMotorController frontRight, BaseMotorController rearRight) {
    ...
    public BaseMotorController getTalon(TalonID id) {
        switch (id) {
            case FRONT_LEFT:
                return m_frontLeft;
            case FRONT_RIGHT:
    ...
    public void setLeftRightMotorOutputs(double leftOutput, double rightOutput) {
        ...
        m_rearRight.set(ControlMode.PercentOutput, m_rearRightInverted * limit(rightOutput) * m_outputScale);
    }
}